...
class UserData {
  ...
  Future<UserModel> getUserModel() async {
    ...
    // If the user is not found or there's an error, return a default UserModel or handle the error accordingly.
    return UserModel(total: 0, cost: 0);
  }
  ...
  Future<double> calculateTotalBookSum(BuildContext context) async {
    ...
    final QuerySnapshot snapshot =
        await firestore.collection("user").doc(mail!).collection("books").get();
